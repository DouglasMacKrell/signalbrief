...
/** True when briefings are generated by a local LLM (Ollama), not the rules engine. */
export function isLlmBriefingConfigured(): boolean {
  return isOllamaEnabled() && process.env.BRIEFING_PROVIDER === "ollama";
}
